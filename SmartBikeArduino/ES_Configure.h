...
#define SERV_0_HEADER "../LEDService.h"
// the name of the Init function
#define SERV_0_INIT InitLEDService
// the name of the run function
#define SERV_0_RUN RunLEDService
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_1_HEADER "../LightSensorService.h"
// the name of the Init function
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_2_HEADER "../AccelerometerService.h"
// the name of the Init function
#define SERV_2_INIT InitAccelerometerService
// the name of the run function
#define SERV_2_RUN RunAccelerometerService
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_3_HEADER "../BluetoothService.h"
// the name of the Init function
#define SERV_3_INIT InitBluetoothService
// the name of the run function
#define SERV_3_RUN RunBluetoothService
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_4_HEADER "../LogicFlow.h"
// the name of the Init function
#define SERV_4_INIT InitLogicFlow
// the name of the run function
#define SERV_4_RUN RunLogicFlow
// How big should this services Queue be?
...
// the header file with the public function prototypes
//prefix filename with ../ and surround with ""
#define SERV_5_HEADER "../PseudoUserSetting.h"
// the name of the Init function
#define SERV_5_INIT InitPseudoUserSetting
// the name of the run function
#define SERV_5_RUN RunPseudoUserSetting
// How big should this services Queue be?
...
#define TIMER0_RESP_FUNC PostLEDService
#define TIMER1_RESP_FUNC PostLightSensorService
